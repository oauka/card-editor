...
const INIT_TEXTS_BIZ = [
  {id:"bt1", xMM:MAR+3, yMM:MAR+3,  text:"홍  길  동",  fs:12, color:"#1a2744", bold:true,  italic:false, rotate:0, font:"'Noto Sans KR',sans-serif"},
  {id:"bt2", xMM:MAR+3, yMM:MAR+15, text:"직  책",      fs:8,  color:"#2d3748", bold:false, italic:false, rotate:0, font:"'Noto Sans KR',sans-serif"},
  {id:"bt3", xMM:MAR+3, yMM:MAR+23, text:"010-0000-0000",fs:8, color:"#1a2744", bold:false, italic:false, rotate:0, font:"'Noto Sans KR',sans-serif"},
  {id:"bt4", xMM:MAR+3, yMM:MAR+30, text:"example@email.com",fs:7,color:"#2d3748",bold:false,italic:false,rotate:0,font:"'Noto Sans KR',sans-serif"},
];
  ...
  useEffect(()=>{
    ...
    const onMove = e=>{
      ...
      if(eDrag.current){
        ...
        const xMM=startXMM+(cl.clientX-startCX)/ppm;
        const yMM=startYMM+(cl.clientY-startCY)/ppm;
  ...
  return(
    <div style={{fontFamily:"'Noto Sans KR','Apple SD Gothic Neo','Malgun Gothic',sans-serif",
      ...
      <div ref={copyrightRef} style={{position:"fixed",top:0,left:0,right:0,zIndex:300,
        ...
        <span>Copyright 2026. MUJIMUJI Card Editor All rights reserved. &nbsp;|&nbsp; 본 서비스(에디터)의 무단 복제, 수정 및 배포를 금지합니다.</span>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"row",overflow:"hidden",background:"#ecf0f1",marginRight:180}}>
        ...
        <div onMouseDown={e=>{if(e.target===e.currentTarget){setSel(null);setEditing(null);setSelGuide(null);setShowIconPicker(false);}}} style={{flex:1,minWidth:0,display:"flex",flexDirection:"column",
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,marginTop:10,flexWrap:"wrap",justifyContent:"center"}}>
            ...
            <div style={{width:1,height:20,background:"rgba(0,0,0,.15)",margin:"0 2px"}}/>
            <button onClick={()=>applyPreset(90,58,"landscape")}
            ...
            <button onClick={()=>applyPreset(92,52,"landscape")}
              style={{padding:"3px 9px",
